...
namespace _4321Afanasev.Middlewares
{
...
{
    exception.InnerException?.Message ?? "Unknown error"
};
    ...
    public class ResponseModel<T>
    {
        ...
        public string Message { get; set; } = string.Empty; // Инициализация строки
        ...
        {
            Succeeded = true;
            Message = message ?? string.Empty; // Защита от null
            Data = data;
        }
